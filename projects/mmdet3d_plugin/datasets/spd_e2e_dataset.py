...
from projects.mmdet3d_plugin.datasets.eval_utils.eval_utils import class_range, inf_class_range


@DATASETS.register_module()
class SPD_E2E_Dataset(NuScenesDataset):
    ...
    def __init__(self,
        ...
        if self.new_range_100:
            self.class_range = inf_class_range
