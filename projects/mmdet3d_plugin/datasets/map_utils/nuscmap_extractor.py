...
import numpy as np
from projects.mmdet3d_plugin.datasets.eval_utils.map_api import NuScenesMapExplorer
...
class NuscMapExtractor(object):
    ...
    """
    def __init__(self, nusc_maps, data_root: str, roi_size: Union[List, Tuple]) -> None:
        ...
        self.map_explorer = {}
        for loc, map in self.nusc_maps.items():
            self.map_explorer[loc] = NuScenesMapExplorer(map)
