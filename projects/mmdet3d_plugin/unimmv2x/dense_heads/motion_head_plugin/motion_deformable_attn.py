...
from projects.mmdet3d_plugin.unimmv2x.modules.multi_scale_deformable_attn_function import MultiScaleDeformableAttnFunction_fp32
from projects.mmdet3d_plugin.unimmv2x.modules.moe import Expert, MoE
...
class MotionTransformerAttentionLayer(BaseModule):
    ...
    def __init__(self,
        ...
        self.moe_expert_ffn_channels = 256
        self.moe_expert_act_cfg = dict(type='ReLU', inplace=True)
        self.moe_expert_ffn_drop = 0.0
