...
model_other_agent_inf = dict(
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            embed_dims=_dim_,
            encoder=dict(
                type="BEVFormerEncoder", # MoE-Enhanced
                num_layers=6,
                pc_range=inf_point_cloud_range,
...
model_ego_agent = dict(
    ...
    freeze_img_neck=True,
    freeze_bn=True,
    freeze_bev_encoder=True, # False origin
    freeze_trackformer=True,
    freeze_motionformer=False,
    score_thresh=0.4,
    filter_score_thresh=0.35,
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            decoder=dict(
                ...
                return_intermediate=True,
                transformerlayers=dict(
                    type="DetrMoETransformerDecoderLayer",
                    attn_cfgs=[
                        dict(
                            type="MultiheadAttention",
                            embed_dims=_dim_,
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            "model_ego_agent.pts_bbox_head": dict(lr_mult=0.1),
        }
    ),
    weight_decay=0.01,
)
...
load_from = "ckpts/unimmv2x_e2e_stg1.pth"
